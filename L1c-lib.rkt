#lang racket
; the library for 1-compiler functions
...
(define (sx? this) (or (equal? this 'rcx)))
(define (label? this) 
...
(define (reg? text) (member text '(rax rbx rcx rdx rsp rbp rdi rsi r8 r9 r10 r11 r12 r13 r14 r15)))
